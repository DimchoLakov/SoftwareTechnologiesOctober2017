...
class FilmController extends Controller
{
    ...
    {
        $film = new Film();
        $form = $this->createForm(FilmType::class, $film); //Създаваме форма от тип FilmType
        $form->handleRequest($request); //Наливаме данните във формата
        $errorMsg = "";
        if ($form->isSubmitted()) {
            if ($form->isValid()) {
    ...
    public function edit($id, Request $request)
    {
        ...
        $form = $this->createForm(FilmType::class, $film)->handleRequest($request);
        $errorMsg = "";
        ...
        if ($form->isSubmitted()) {
            if ($form->isValid()) {
                ...
                $errorMsg = "You cannot edit non-existing film!";
            }
        }
